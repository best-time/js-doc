...
function Swipe(container, options) {
  ...
  var _baseOption = {
    startSlide: 0,
    auto: 0,
    speed: 300, // transition 动画时间
    continuous: true, // 是否可循环滑动
  ...
  function translate(index, dist, speed) {
    ...
    style.webkitTransitionDuration = style.MozTransitionDuration = style.transitionDuration =
      speed + "ms";
  ...
  var events = {
    ...
    move: function(event) {
      ...
      var isValidSlide = fasrMoveEnd ||  Math.abs(delta.x) > width / 2;
