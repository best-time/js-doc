(function(factory) {
  ...
  Positions.prototype = {
    ...
    setPoints: function(points) {
      if (points.elmX) this.points.elmX = points.elmX;

      if (points.elmY) this.points.elmY = points.elmY;

      if (points.firstMouseX) this.points.firstMouseX = points.firstMouseX;

      if (points.firstMouseY) this.points.firstMouseY = points.firstMouseY;

      if (points.lastMouseX) this.points.lastMouseX = points.lastMouseX;

      if (points.lastMouseY) this.points.lastMouseY = points.lastMouseY;
    },
    getPoints: function() {
      return this.points;
    },
  ...
  function RestrictionDecorator(Positions, el, restrictEl) {
    ...
    if (restrictEl == "document") {
      ...
      if (typeof restrictEl != "object")
        throw new Error(
          "Restrict must be object: " + 'document.getElementById("obj_id")'
        );
  ...
  ViinyDragger.instance = function(el, options) {
    ...
    this.ClsManager = new ClassManager();
  ...
  ViinyDragger.instance.prototype = {
    mousedownHandler: function(e) {
      ...
      this.ClsManager.addClass(this.el, this.options.activeClass);
...
// })
    ...
    mouseupHandler: function(e) {
      ...
      // remove activeClass
      this.ClsManager.removeClass(this.el, this.options.activeClass);
